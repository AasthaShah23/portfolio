  ...
  return (
    <ToastProvider>
        ...
        <div className="page-container w-[min(1160px,_calc(100%_-_96px))] mx-auto max-[1100px]:w-[calc(100%_-_64px)] max-[600px]:w-[calc(100%_-_40px)]  grid grid-cols-[1fr_1fr] gap-[110px] items-start max-[1100px]:gap-[50px] max-[800px]:gap-[30px] max-[600px]:grid-cols-[1fr] max-[600px]:gap-[38px]">
          <div>
            ...
            <p
              ...
              data-reveal
            >
              A new idea, a role that feels like a fit, or just a good conversation. My inbox is
              open.
            </p>
            <div
      ...
      <Toast
        ...
        variant={submitStatus === 'error' ? 'destructive' : 'success'}
        duration={6000}
        role={submitStatus === 'error' ? 'alert' : 'status'}
      >
        {submitStatus === 'error' && (
          <span className="grid size-8 shrink-0 place-items-center rounded-full bg-white/12 text-white">
        ...
        <div>
          <ToastTitle>{submitStatus === 'error' ? 'Message not sent' : 'Message sent'}</ToastTitle>
          <ToastDescription>{submitMessage}</ToastDescription>
        </div>
        <ToastClose />
      </Toast>
      <ToastViewport />
